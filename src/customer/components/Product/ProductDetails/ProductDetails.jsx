    ...
    <div className="bg-white lg:px-20">
      <div className="pt-6">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10">
              ...
              {product.images.map((item) => (
                <div className="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg">
                  <img
                    alt={item.alt}
                    src={item.src}
                    className="aspect-[3/2] rounded-lg object-cover max-w-[5rem] max-h-[5rem] mt-4"
                  />
                </div>
              ))}
            </div>
          ...
          {/* Product info */}
          <div className="lg:col-span maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24 ">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              >
                <div className="flex item-center space-x-6">
                  ...
                  <p className="opacity-50 text-sm">1509 Rating</p>
                  <p className=" ml-3text-sm font-medium text-indigo-600 hover:text-indigo-500">
                    56540 Rating
                  </p>
                </div>
              </div>
            ...
            <Grid container spacing={7}>
                ...
                <Grid item xs={5} >
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <p className="opacity-60 m-0 p-0">5780  Rating</p>
                  </div>
                    <Box className="mt-5 space-y-2">
                      ...
                      <Grid container  alignItems="center" gap={2}>
                        ...
                        <Grid item xs={7}>
                          <LinearProgress sx={{bgcolor:"#d0d0d0", borderRadius:4,height:7}} variant="determinate" value={70} color="success"></LinearProgress>
                        </Grid>
                      </Grid>
                      <Grid container  alignItems="center" gap={2}>
                        <Grid item xs={2}>
                        ...
                        <Grid item xs={7}>
                          <LinearProgress sx={{bgcolor:"#d0d0d0", borderRadius:4,height:7}} variant="determinate" value={60} />
                        </Grid>
                      </Grid>
                      <Grid container  alignItems="center" gap={2}>
                        <Grid item xs={2}>
        ...
        <section className="pt-10 mb-10">
          ...
          <div className="flex  justify-around items-center p- flex-wrap space-y-5">
            {
            mens_kurta.slice(0, 10).map((item,index)=> <HomeSectionCard key={index} currData={item} />)
            }
          </div>
        </section>
      </div>
